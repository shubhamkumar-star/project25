...
function setup() {
	...
	var bob_options={ isStatic:false, 
	 ...
	 bob1 =Bodies.circle(320,350,20,bob_options);
	  ...
	  bob2 =Bodies.circle(320,350,20,bob_options);
	  World.add(world,bob2);

	  bob3 =Bodies.circle(320,350,20,bob_options);
	  World.add(world,bob3);

	  bob4 =Bodies.circle(320,350,20,bob_options);
	  World.add(world,bob4);

	  bob5 =Bodies.circle(320,350,20,bob_options);
